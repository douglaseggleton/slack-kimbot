    ...
    .then(function (response) {
      ...
      return clients.foursquare.explore(process.env.LAT,
        ...
        .then(function (res) {
          ...
          if (isCold) {
            return 'It\'s a bit cold outside (it\'s ' + Math.round(tempCelsius) + ' degrees)! Let\'s not venture too far for ' +
              'coffee ' + venueLink;
          }
...
Kimbot.prototype.getLunchRecommendation = function (cuisineType) {
  ...
  return this.clients.weather
    ...
    .then(function (response) {
      ...
      var sectionType = !cuisineType ? section : undefined;
      var query = cuisineType ? cuisineType : undefined;
      ...
      return clients.foursquare.explore(process.env.LAT,
        ...
        .then(function (res) {
          ...
          if (isCold) {
            return 'It\'s a bit cold outside! Let\'s not venture too far for ' +
              'lunch ' + venueLink;
          }
